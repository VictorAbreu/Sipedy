...
public class ClienteControllerIT {
	...
	public void findAllDeveriaRetornarPageOrdenadoQuandoOrdenadoPorNomeRazao() throws Exception{
		...
		ResultActions result = mockMvc.perform(get("/clientes?page=0&size=12&sort=nomeRazao,asc")
	...
	@Test
	public void updateDeveriaRetornarClienteDTOQuandoIdExistir() throws Exception {
		
		String accessToken = tokenUtil.obtainAccessToken(mockMvc, userName, password);
		
		ClienteDTO productDTO = Factory.createClienteDto();
